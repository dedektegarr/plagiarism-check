        ...
        <form role="form text-left" wire:submit.prevent="register">
            ...
            <div class="mb-4">
                <input type="text" wire:model="name"
                    class="@error('name') invalid-input @enderror placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border 
            ...
            <p class="mt-4 mb-0 leading-normal text-sm">Sudah punya akun? <a href="/login"
